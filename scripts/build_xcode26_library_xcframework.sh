...
#   ./scripts/build_xcode26_library_xcframework.sh -c release -m MacLibrary -v 1.3.0 -o dist/1.10.0/mac/mac-native-toolkit-1.3.0.xcframework --minimum-macos 15.0
#   ./scripts/build_xcode26_library_xcframework.sh -c release -m UnityMacPlugin -v 1.3.0 -o dist/1.10.0/mac/unity-mac-native-toolkit-1.3.0.xcframework --minimum-macos 15.0
