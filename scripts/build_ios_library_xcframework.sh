...
#   ./scripts/build_ios_library_xcframework.sh -c release -m IosLibrary -v 1.1.0 --output dist/1.2.0/ios/ios-native-toolkit-1.1.0.xcframework
#   ./scripts/build_ios_library_xcframework.sh -c release -m UnityIosPlugin -v 1.1.0 --output dist/1.2.0/ios/unity-ios-native-toolkit-1.1.0.xcframework
