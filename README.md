...
- Manual: `docs/1.10.0/manual/index.md`
- Published docs: `docs/1.10.0/manual/`
...
- `mac/MacLibrary`
  - Core: `MacDialogManager` / `MacNotificationManager` / `MacShareManager` / `MacClipboardManager`
  - Variants: Alert / File / MultiFile / Folder / MultiFolder / Save / Notification / Share / Clipboard
  - Docs: DocC (`.docc`)
