...
/*
    ...
    namespace WindowsLibraryExample
    {
...
namespace winrt::WindowsLibraryExample::implementation
{
    ...
    struct XamlMetaDataProvider : public ::winrt::WindowsLibraryExample::implementation::XamlMetaDataProvider_base<XamlMetaDataProvider>
    {
