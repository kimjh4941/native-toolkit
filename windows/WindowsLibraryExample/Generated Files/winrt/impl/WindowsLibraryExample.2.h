...
#pragma once
#ifndef WINRT_WindowsLibraryExample_2_H
#define WINRT_WindowsLibraryExample_2_H
#include "winrt/impl/Microsoft.UI.Xaml.1.h"
#include "winrt/impl/Microsoft.UI.Xaml.Markup.1.h"
#include "winrt/impl/WindowsLibraryExample.1.h"
WINRT_EXPORT namespace winrt::WindowsLibraryExample
{
    struct WINRT_IMPL_EMPTY_BASES MainWindow : winrt::WindowsLibraryExample::IMainWindow,
        ...
        impl::require<MainWindow, winrt::Microsoft::UI::Xaml::IWindow, winrt::Microsoft::UI::Xaml::IWindow2>
    {
        ...
        MainWindow(void* ptr, take_ownership_from_abi_t) noexcept : winrt::WindowsLibraryExample::IMainWindow(ptr, take_ownership_from_abi) {}
        MainWindow();
    };
