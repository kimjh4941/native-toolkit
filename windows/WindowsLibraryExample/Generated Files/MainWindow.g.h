...
namespace winrt::WindowsLibraryExample::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES MainWindow_base : implements<D, WindowsLibraryExample::MainWindow, composing, I...>,
        ...
        impl::base<D, winrt::Microsoft::UI::Xaml::Window>
    {
        ...
        using class_type = WindowsLibraryExample::MainWindow;
        ...
        {
            return L"WindowsLibraryExample.MainWindow";
        }
        MainWindow_base()
        {
...
namespace winrt::WindowsLibraryExample::factory_implementation
{
    ...
    {
        using instance_type = WindowsLibraryExample::MainWindow;
