...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"WindowsLibraryExample.MainWindow"))
    {
        return winrt_make_WindowsLibraryExample_MainWindow();
    }

    if (requal(name, L"WindowsLibraryExample.XamlMetaDataProvider"))
    {
        return winrt_make_WindowsLibraryExample_XamlMetaDataProvider();
    }
