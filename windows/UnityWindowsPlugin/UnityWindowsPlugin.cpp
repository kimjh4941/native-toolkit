// UnityWindowsPlugin.cpp : DLL の初期化ルーチンを定義します。
//

#include "pch.h"
#include "framework.h"
#include "UnityWindowsPlugin.h"
...
BEGIN_MESSAGE_MAP(CUnityWindowsPluginApp, CWinApp)
END_MESSAGE_MAP()


// CUnityWindowsPluginApp の構築

CUnityWindowsPluginApp::CUnityWindowsPluginApp()
{
...
// 唯一の CUnityWindowsPluginApp オブジェクト

CUnityWindowsPluginApp theApp;

const GUID CDECL _tlid = {0xcfd499f0,0x8943,0x4de7,{0x8d,0xc7,0x02,0x72,0x53,0x57,0x20,0x62}};
const WORD _wVerMajor = 1;
const WORD _wVerMinor = 0;


// CUnityWindowsPluginApp の初期化

BOOL CUnityWindowsPluginApp::InitInstance()
{
