...
- The package includes native plugins and samples for Android / iOS / Windows / macOS, and dialog operations are available through singleton APIs.
...
1. Place `native-toolkit-1.0.0.aar` in `app/libs`.
